...
export const defaultPagePreloaderRef = {
    current: defaultPreloader
}
...
export default () => {
    ...
    return createPortal(
        <AnimatePresence>
            {active &&
                <Motion.Div className="screen-loader">
                    <svg viewBox="0 0 100 100" enableBackground="new 0 0 100 100" xmlSpace="preserve">
